...
| --- | --- | --- |
| M0 | [Read-only Mini baseline](m0-mini-baseline-2026-09-23.md): API release SHA, app/process/endpoint counts, active operations and incidents. [Control-store measurement](m0-mini-measurements-2026-09-24.md): running binary hash, active DB identity, schema dump hash, bytes and connections. | Prove binary/source/schema mapping; measure growth; map jobs/routes/volumes/DB ownership; make sanitized and private restore fixtures; reconcile ADR dispositions, owners and budgets. |
