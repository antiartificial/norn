...
Status: planning baseline with local implementation started on `codex/v3-foundations`, 2026-09-22. Scope incorporates the user's Mini/Fleet clarification. Provisioning and live cutovers have not started. Detailed ADRs remain proposed where decisions are unresolved.
