...
func init() {
	...
	hostCmd.AddCommand(hostCloudflaredRecoverCmd)
...
var hostCloudflaredRecoverCmd = hostScriptCommand("cloudflared-recover [host-runtime flags]", "Validate and recover the Norn-owned cloudflared LaunchAgent", "cloudflared-recover")
