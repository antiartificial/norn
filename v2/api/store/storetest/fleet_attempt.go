...
// store.FleetAttemptStore — revision-CAS and heartbeat-lease fencing. newStore
// must return a store backed by empty attempt tables on each call.
func RunFleetAttemptStoreConformance(t *testing.T, newStore func(t *testing.T) store.FleetAttemptStore) {
