...
func TestSyntheticMiniControlUpgradeAndReaderBoundary(t *testing.T) {
	...
	// Migrations 22, 28, 29, and 30 raise the writer floor.
	...
	if !errors.As(err, &incompatible) || incompatible.Contract != "writer" || incompatible.Required != MySQLSourceStopWriterVersion {
