...
func ParseContainerName(name string) (ParsedName, error) {
	...
	// Rolling worker generations alternate between the stable name and a
	// temporary -new suffix. Treat both as the same logical allocation during
	// restart reconciliation while retaining the actual runtime name in state.
