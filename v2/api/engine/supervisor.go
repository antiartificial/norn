...
func (e *Engine) restartContainer(ctx context.Context, inst *Instance, exitCode *int) {
	...
	// Starting the stopped container preserves its original environment,
	// volumes, command, resource limits, and port publications. Recreating it
	// from the redacted inventory would lose secrets after a crash.
