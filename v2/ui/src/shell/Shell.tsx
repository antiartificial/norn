...
const navGroups = [
  { label: 'Operate', items: [['/overview', 'Overview', 'fa-gauge-high'], ['/apps', 'Apps', 'fa-grid'], ['/releases', 'Releases', 'fa-code-branch'], ['/deploys', 'Deploys', 'fa-rocket-launch'], ['/incidents', 'Incidents', 'fa-circle-exclamation'], ['/operations', 'Operations', 'fa-clipboard-check'], ['/activity-log', 'Activity Log', 'fa-shield-halved']] },
